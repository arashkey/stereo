...
trainImageList=[704:710,712:716];%[702:710, 711:719];                                   %<<<-----------------------HARD CODED
testImageList=[711];%[693:701];                                        %<<<-----------------------HARD CODED
...
disp(['for ii=' num2str(5) ' disp error = '  num2str(Results(1).Error) ' disp AUC = '  num2str(Results(1).AUC) ''])

figure;imshow(Results(1).Values);
figure;imshow(Results(1).FinalDisp  ,[] );
